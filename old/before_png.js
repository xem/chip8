V.width=64;
n=[];
for(a=80;a--;)n[a]="0x"+"F999F26227F1F8FF1F1F99F11F8F1FF8F9FF1244F9F9FF9F1FF9F99E9E9EF888FE999EF8F8FF8F88"[a]<<4;
for(a=3;a<8192;a+=4)
  q.data[a]=255;
          ...
          e(
            [
              ...
              [
                ...
                "for(a=b;a--;)V[a]=n[k+a]",
                "V[b]=w",,
                "for(a=b;a--;)n[k+a]=V[a]","~(V[b]=s.indexOf('w'))||(h-=2)",
...
onkeydown=onkeyup=function(c){
  s[[0,7,8,9,4,5,6,1,2,3,33,39,21,34,36,41].indexOf(c.keyCode%48)]=c.type[5]
}